...
<body>
   ...
   <main class="main-container">
    ...
    <section class="nivel">
        ...
        <input type="radio" id="Bachillerato" name="nivelEdu">
        ...
        <section class="grado">
            <p>Seleccione los grados que tiene en Bachillerato</p>
                    ...
                    <input type="checkbox" id="noveno" name="grado">
                    <label for="noveno"> 9º</label>
                    <input type="checkbox" id="decimo" name="grado">
                    <label for="decimo"> 10º</label>
                    <input type="checkbox" id="once" name="grado">

...
<head>
    ...
    <link rel="stylesheet" href="../../css/asistenciaCrearYactuali.css">
...
<body>
    <header class="containernav">
        <figure class="logo">
            ...
            <nav>
                <a href="../cursos.html" class="item-options">volver</a>
            </nav>
        
    </header>
    <main class="main-container">
        <header><h1>Subir Asistencia</h1></header>
       <section class="container">
        <form action="formulario">
            <section class="datos">
            <label for="">Fecha asistencia</label>
            <input type="date" name="fecha-asistencia" value="16-2023" required>
            </section>
            <section class="datos">
                <label for="">Asistencia</label>
                <input type="text" name="asistencia" required value="Asistio">
                </section>
                <section class="btn">

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $consultar = $base_de_datos->prepare("SELECT id_rol, id_jornada FROM registo WHERE num_doc = ?");
        ...
        $sql = "INSERT INTO asistencia (fecha_asistencia, asistencia, registro_num_doc, registro_rol_id_rol, registro_jornada_id_jornada) 
                VALUES (:fecha_asistencia, :asistencia, :registro_num_doc, :registro_rol_id_rol, :registro_jornada_id_jornada :id_asstencia)";
        ...
        $stmt->execute([
            ...
            ':registro_rol_id_rol' => $registro_rol_id_rol,
            ':registro_jornada_id_jornada' => $registro_jornada_id_jornada,
            ':id_asstencia' => $id_asstencia
        ]);

    ...
    <div class="container d-flex justify-content-between align-items-left">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="navbar-nav ms-auto fs-5">
              <a class="nav-link active" href="../admin/pag_principal.html">Volver</a>
      ...
      <section class="col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
        <section class="card">
          <section class="card-body text-center" style="font-family: Arial, Helvetica, sans-serif;">
            ...
            <h5 class="card-title text-center"><b>Título: </b><?php echo htmlspecialchars($item->logro); ?></h5>
            <p class="card-text"><b>Descripción: </b><?php echo htmlspecialchars($item->descripcion_logro); ?></p>
        ...
        <div class="modal-body">
          <form method="POST" action="guardarDatos.php">
            ...
            <div class="mb-3">
              ...
              <input name="logro" type="text" class="form-control" id="nameLogroUpdate<?=$item->codigo_logro?>" value="<?= htmlspecialchars($item->logro) ?>">
            </div>
            <div class="mb-3">
              <label for="descripLogroUpdate<?=$item->codigo_logro?>" class="form-label">Descripción del Logro</label>
              <input name="descripcion_logro" type="text" class="form-control" id="descripLogroUpdate<?=$item->codigo_logro?>" value="<?= htmlspecialchars($item->descripcion_logro) ?>">
            </div>
            <div class="mb-3">
                    ...
                    <div class="modal-body">
                      <form method="post" action="registrarLogro.php">
                        ...
                        <div class="mb-3">
                          ...
                          <input placeholder="Escribe el titulo del logro" name="logro" type="text" class="form-control" id="nameLogro">
                        </div>
                        <div class="mb-3">
                          <label for="descripLogro" class="form-label">Descripciòn del Logro</label>
                          <textarea placeholder="Escribe la descripcion del logro" name="descripcion_logro" class="form-control" id="descriplogro" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
